...
% auto: 在 Windows 上自动使用 SimSun 等原 Word 字体，macOS 使用华文字体，
% Overleaf 免费版自动回退到 TeX Live 自带的 Fandol 字体，10 秒限制内可正常编译。
% Overleaf 免费版若需进一步优化编译时间，可改为 fontset=overleaf,fastcompile。
